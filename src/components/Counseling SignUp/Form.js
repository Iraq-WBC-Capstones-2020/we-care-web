...
function Form() {
  return (
    <div className="order-2 lg:order-1 lg:w-1/2 w-4/5 bg-white rounded-lg md:flex md:justify-center py-16 lg:py-10 lg:px-8 lg:m-0 my-20 mx-20">
      <form className="w-full max-w-sm text-darkP">
        <div className="md:flex md:items-center mb-6 justify-between">
          <div className="md:w-2/5 flex justify-end">
            <label className="block mb-1 md:mb-0 pr-6">Full Name:</label>
          </div>
        ...
        <div className="md:flex md:items-center mb-6">
          <div className="md:w-2/5 flex justify-end">
            <label className="block mb-1 md:mb-0 pr-6">Profile Picture:</label>
          </div>
          <div className="md:w-3/4">
        ...
        <div className="md:flex md:items-center mb-6">
          <div className="md:w-2/5 flex justify-end">
            <label className="block mb-1 md:mb-0 pr-6">About(Optional):</label>
          </div>
          <div className="md:w-3/4">
            <textarea
        ...
        <div className="md:flex md:items-center mb-6">
          <div className="md:w-2/5 flex justify-end">
            <label className="block mb-1 md:mb-0 pr-6">Expertise:</label>
          </div>
          <div className="md:w-3/4">
            <input
              className="border border-darkP rounded w-full py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-darkBeige"
        ...
        <div className="md:flex md:items-center mb-6">
          <div className="md:w-2/5 flex justify-end">
            <label className="block mb-1 md:mb-0 pr-6">Certificate:</label>
          </div>
          <div className="md:w-3/4">
            <div className="md:flex md:items-center mb-6 overflow-hidden relative">
              <button className="border border-darkP rounded w-full pl-2 mt-5 leading-tight focus:outline-none focus:bg-white focus:border-darkBeige inline-flex items-center">
        ...
        <div className="flex items-center justify-end">
          ...
          <div className="md:w-2/5 ml-2 mt-2">
            <button
